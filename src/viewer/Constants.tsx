...
export const ACTION_ROW_SIZE = 1.4; //vw
...
export const DATASOURCE_AND_DATAPURPOSE_PADDING_TOP = 0.4;//DATASOURCE_AND_DATAPURPOSE_ROW_SIZE;
export const DATASOURCE_AND_DATAPURPOSE_PADDING_BOTTOM = 0.4;//DATASOURCE_AND_DATAPURPOSE_ROW_SIZE;
...
export const TEXT_SPACING = 1.25;
